FROM --platform="linux/amd64" livepeerci/cuda:11.7.1-cudnn8-devel-ubuntu20.04 as build
...
COPY	./ci_env.sh	./ci_env.sh
RUN	./ci_env.sh make
#livepeer livepeer_cli livepeer_bench livepeer_router

#FROM --platform="linux/amd64"	nvidia/cuda:11.7.1-base-ubuntu22.04
